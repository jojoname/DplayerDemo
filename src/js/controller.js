...
class Controller {
    constructor(player) {
        ...
        this.initPlayButton();
        this.initThumbnails();
        // console.log('this.player.options.disableDrag',this.player.options.disableDrag,!this.player.options.disableDrag)
        if (!this.player.options.disableDrag) {
            this.initPlayedBar();
        }
        this.initFullButton();
            ...
            this.player.template.camareButton.addEventListener('click', () => {
                ...
                canvas.toBlob((blob) => {
                    try {
                        ...
                        this.player.notice(this.player.tran('please-play'));
                    }
                });
            });
        }
