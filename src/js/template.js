...
class Template {
    ...
    init() {
        ...
        this.danmakuFontBar = this.container.querySelector('.dplayer-danmaku-font-bar-inner');
        this.danmakuFontBarWrap = this.container.querySelector('.dplayer-danmaku-font-bar');
        this.danmakuFontBarWrapWrap = this.container.querySelector('.dplayer-danmaku-font-bar-wrap');
        this.fontInput = this.container.querySelector('.dplayer-comment-setting-font input');
